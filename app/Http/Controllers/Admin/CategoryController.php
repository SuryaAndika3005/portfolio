 ...
 * four-item $accordionPanels array keyed to exactly the slugs
 * graphic-design/uiux-design/it-development/ai-data, one panel per
 * discipline. Any category outside
