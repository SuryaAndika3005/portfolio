<x-layout>
    ...
    <header class="relative max-w-[1600px] mx-auto px-8 lg:px-20 pt-32 pb-24 flex flex-col items-center justify-center text-center min-h-[80vh] overflow-hidden">
        ...
        <div class="relative z-10 max-w-3xl">
            ...
            <h2 class="text-xl sm:text-2xl lg:text-3xl font-bold mb-6 h-9 sm:h-10 lg:h-11 flex items-center justify-center">
            ...
            <p class="text-slate-500 mb-12 max-w-xl mx-auto text-base sm:text-lg lg:text-xl leading-relaxed">
                I craft bold visual identities and brand materials, backed by the ability to design and build the digital products that carry them, from concept to high-performance code.
            </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div class="lg:col-span-7 text-center lg:text-left">
                ...
                <p class="text-slate-600 text-lg leading-relaxed mb-4">
                    I'm Surya, an Informatics student at Andalas University and a graphic designer at 523 Studio. My work sits at the intersection of visual design and web development. I care as much about how something looks as how it's built.
                </p>
                <p class="text-slate-600 text-lg leading-relaxed">
                    From brand identities to full product interfaces, I like owning a project end-to-end: research, design, and, when the project calls for it, the code that ships it.
                </p>
                    ...
                    <div class="scrollbar-thin relative pl-5 border-l-2 border-slate-100 space-y-5 overflow-y-auto pr-2 -mr-2">
                        @foreach ($items as $item)
                            <div class="relative">
                                ...
                                <p class="text-[11px] font-bold text-blue-500 uppercase tracking-wider mb-1">{{ $item->duration }}</p>
        ...
        <div class="max-w-[1600px] mx-auto px-8 lg:px-20 mt-32 relative z-10 border-t border-slate-800/50 pt-8 pb-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            ...
            <div class="flex space-x-5">
                ...
                <a href="https://instagram.com/surdik_28" target="_blank" rel="noopener" class="text-slate-500 hover:text-pink-500 transition-colors" aria-label="Instagram profile">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 7a5 5 0 100 10 5 5 0 000-10zm0 8a3 3 0 110-6 3 3 0 010 6zm5.25-8.25a1.25 1.25 0 112.5 0 1.25 1.25 0 01-2.5 0zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 2.16c3.203 0 3.583.012 4.849.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.849.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069z" /></svg>
                </a>
            </div>
