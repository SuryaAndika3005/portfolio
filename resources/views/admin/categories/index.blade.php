...
@section('content')
    ...
    <p class="text-small text-muted mb-6 max-w-2xl">
        Creating new categories through this page is disabled for now. The homepage's Selected Works section has one panel each for Graphic Design, UI/UX Design, Web & Systems, and AI & Data. Names can be renamed freely; slugs stay fixed because the public site's category-aware layout depends on them.
    </p>
